<template>
  <!-- <a-table :dataSource="tableData" :columns="columns" :pagination="false">
    <template #bodyCell="{ column, text, record }">
      <div v-if="column.dataIndex == 'action'" v-for="item in 100">
        <div style="height: 200px;">
          <a-row style="display: flex;width: 100%;height: 80px;">
            <a-col :span="12">
              <div class="cellStyle">
                <span>学习能力：</span>
                <a-radio-group v-model:value="record.selectStudyAbilityValue" name="radioGroup">
                  <a-radio-button value="1">强</a-radio-button>
                  <a-radio-button value="2">较强</a-radio-button>
                  <a-radio-button value="3">一般</a-radio-button>
                  <a-radio-button value="4">较弱</a-radio-button>
                  <a-radio-button value="5">不具备</a-radio-button>
                  <a-radio-button value="6">不了解</a-radio-button>
                </a-radio-group>
              </div>
            </a-col>
            <a-col :span="12">
          ...
          <a-row style="display: flex;width: 100%;">
            <a-col :span="24">
              <div class="evaluateStyle">
                <span>
                  主观评价：
                </span>
                <a-input v-model:value="record.subjectiveEvaluation" placeholder="非必填，500字以内" />
              </div>
            </a-col>
          </a-row>
        </div>
